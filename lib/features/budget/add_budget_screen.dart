...
class _AddBudgetScreenState extends State<AddBudgetScreen> {
  ...
  Future<void> _load() async {
    ...
    final existingBudgets = await BudgetRepo().getByMonth(widget.year, widget.month);
      ...
      return Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.check_circle_outline_rounded, size: 64, color: NeoBrutalColors.success),
